...
Public Class Dataview
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If sensor = "所有传感器" Then
            sql = "select d.no as 序号 ,d.src as 节点号,d.datetime as 日期时间,s.sensorname as 传感器 ,d.value1 as 数据值1,d.value2 as 数据值2 from data d, sensortype s where d.sensortype=s.sensortype order by no desc limit 0,20"
        Else
            sql = "select d.no as 序号 ,d.src as 节点号,d.datetime as 日期时间,s.sensorname as 传感器 ,d.value1 as 数据值1,d.value2 as 数据值2 from data d, sensortype s where d.sensortype=s.sensortype and d.sensortype= " & sensor & " order by no desc limit 0,20"
        End If
        MyGridViewBind(sql)
    End Sub
End Class