...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <p>
        节点：<asp:DropDownList ID="nodelist" runat="server" DataTextField="location" 
            DataValueField="srcno" Height="16px" Width="131px">
        </asp:DropDownList>
        <asp:Button ID="Button1" runat="server" Text="删除" Width="114px" OnClientClick='if (!confirm("你确定要删除该地点的所有数据吗？")) {return false;}' />
    <br />
